"""
Django settings for shanti_yuwa_club project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-=2b$^oht8lbr8q=m*l&)v$1^sk@9g3mw40_5qr=iq$#$g#xnzs')
...
WSGI_APPLICATION = 'shanti_yuwa_club.wsgi.application'
